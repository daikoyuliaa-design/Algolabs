Дайко Юлія Андріївна, ІР-12, алгоритмізація та програмування, частина 2, варіант 3, рівень 3. Для заданого бінарного дерева реалізуйте функцію, яка обчислює та повертає
